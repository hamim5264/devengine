...
export default function HeroSection({ config }: HeroSectionProps) {
  return (
    ...
    >
      ...
      <div className="max-w-[1520px] mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 xl:gap-12 items-center relative z-10">
        {/* Left Column: Headline & Stats (Expanded presence & larger title) */}
        <div className="lg:col-span-6 xl:col-span-6 flex flex-col justify-center space-y-8 max-w-2xl">
          {/* Badge */}
          ...
          {/* Main Title (Larger & Crisp) */}
          <h1 className="font-space-grotesk text-4xl sm:text-6xl md:text-7xl lg:text-[68px] xl:text-[76px] font-bold text-white leading-[1.05] tracking-tight">
            {config.title}{" "}
        ...
        {/* Right Column: 3D Perspective Device Mockup Frames (Slightly larger, gently shifted right) */}
        <div className="lg:col-span-6 xl:col-span-6 relative h-[440px] sm:h-[540px] md:h-[630px] lg:h-[690px] xl:h-[730px] flex items-center justify-center [perspective:1200px] select-none w-full">
          {/* Desktop Mockup Frame */}
          <div className="absolute w-[95%] sm:w-[92%] max-w-[760px] z-10 transform translate-x-[1%] -translate-y-[4%] rotate-y-[-12deg] rotate-x-[8deg] shadow-[0_0_75px_rgba(62,243,255,0.2)] rounded-2xl overflow-hidden border border-white/15 bg-[#0A0F1D]/80 backdrop-blur-2xl transition-all duration-500 hover:shadow-[0_0_95px_rgba(62,243,255,0.32)]">
          ...
          {/* Tablet Mockup Frame */}
          <div className="absolute w-[51%] max-w-[365px] z-20 transform translate-x-[25%] translate-y-[18%] rotate-y-[-6deg] rotate-x-[3deg] shadow-[0_0_50px_rgba(0,0,0,0.9)] rounded-3xl overflow-hidden border-[6px] border-[#111827] bg-black">
          ...
          <div className="absolute w-[28%] max-w-[185px] z-30 transform translate-x-[75%] translate-y-[10%] rotate-y-[8deg] rotate-x-[-4deg] shadow-[0_0_60px_rgba(62,243,255,0.25)] rounded-[2rem] overflow-hidden border-[5px] border-[#02040A] bg-black">
